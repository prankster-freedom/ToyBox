...
- **DS08: モバイル最適化戦略**
  - Viewport メタタグ (`content="width=device-width, initial-scale=1.0"`) の適切な設定、および CSS における `box-sizing: border-box` や `dvh` (Dynamic Viewport Height) 単位の使用により、様々なデバイスサイズでの表示ズーム問題を回避します。
