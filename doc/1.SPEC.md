...
- **FR12: チャットログのスクロール機能 (Issue #5)**
  - ユーザーはマウスホイール、スワイプ、フリック操作でチャットログの奥行き方向をスクロールできる。
- **FR13: モバイルレスポンシブ表示の最適化 (Issue #2)**
  - スマートフォン等の小型端末において、ログイン画面およびメイン画面が画面サイズにフィットし、全体が表示されること。
