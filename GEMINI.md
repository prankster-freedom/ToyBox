...
### 1.1. 厳格な承認ベースの進行
一つの操作（コマンド実行、ファイル修正など）が完了したら、その結果を報告し、次のアクションについて**必ずユーザーの明確な承認を得てください。** ユーザーからの指示がない限り、複数の操作をまとめて実行したり、次のステップを推測して進めたりしてはいけません。
...
すべての開発・修正作業は、以下のステップに沿って、原則1（承認ベース）を遵守しながら進めてください。
